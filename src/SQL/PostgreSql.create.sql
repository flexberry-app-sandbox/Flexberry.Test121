...
CREATE INDEX Index57e4c0dbcbc3ff7aab471a01fe0c325cfcc94c3c on Заказ (Сотрудник); 
 ...
 ALTER TABLE Оповещения ADD CONSTRAINT FK61ba50e63df318d0ee0b90a433ab78058c7b9e84 FOREIGN KEY (Заказ) REFERENCES Заказ; 
CREATE INDEX Index61ba50e63df318d0ee0b90a433ab78058c7b9e84 on Оповещения (Заказ); 
